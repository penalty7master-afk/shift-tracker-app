...
# None в заливке -> используется акцентный цвет темы.
STATUS_COLORS = {
...
# Норма выработки по умолчанию для новых продуктов, кг
WEIGHT_NORM = 2100.0

# Максимально допустимая выработка при вводе (защита от опечаток)
WEIGHT_MAX = 100000.0

# Коэффициент оплаты праздничной/усиленной смены по умолчанию
DEFAULT_HOLIDAY_MULT = 2.0

# Дата, от которой отсчитывается ротация операторов 4/4 (по умолчанию)
